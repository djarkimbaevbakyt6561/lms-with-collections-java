...
public class Main {
        ...
        while (!exit) {
            while (!exitLogin) {
                ...
                try {
                    ...
                    switch (num) {
                        case 1 -> {
                            currentUser = User.login(dataBase.users);
                            if (currentUser != null) {
                                isLoggedIn = true;
                                exitLogin = true;
                            }
                        ...
                        case 2 -> {
                            User user = User.forgotYourPassword(dataBase);
                            if (user == null) {
                        ...
                        case 3 -> {
                            User user = User.register(dataBase);
                ...
                if (currentUser.role == Roles.ADMIN) {
                    while (isLoggedIn) {
                        ...
                        try {
                            ...
                            switch (num) {
                                case 1 -> {
                                    Group group = Group.createGroup(dataBase);
                                        ...
                                        while (true) {
                                            ...
                                            for (Group group : dataBase.groups) {
                                                if (groupName.equals(group.groupName)) {
                                                    ...
                                                    dataBase.addStudentToAllStudents(student);
                                                    dataBase.addUser(user);
                                ...
                                case 7 -> {
                                    if (dataBase.allStudents.isEmpty()) {
                                        ...
                                        for (Student student1 : dataBase.allStudents) {
                                ...
                                case 9 -> {
                                    ...
                                    boolean found = false;
                                    for (Lesson lesson : dataBase.allLessons) {
                                ...
                                case 12 -> {
                                    if (dataBase.allInstructors.isEmpty()) {
                                        ...
                                        for (Instructor instructor1 : dataBase.allInstructors) {
                                ...
                                case 13 -> {
                                    if (dataBase.allInstructors.isEmpty()) {
                                        ...
                                        String email = scanner.nextLine();
                                        Group group = getGroup(dataBase, email);
                                        if (group != null) {
                                            ...
                                            while (!updateStudentBoolean) {
                                                ...
                                                try {
                                                    ...
                                                    switch (studentNum) {
                                                        ...
                                                        case 7 -> {
                                                            for (Student student2 : dataBase.allStudents) {
                                ...
                                case 16 -> {
                                    if (dataBase.allInstructors.isEmpty()) {
                                        ...
                                        for (Instructor instructor : dataBase.allInstructors) {
                                            System.out.println(instructor);
                                        }
                                        System.out.print("Введите email: ");
                                        String email = scanner.nextLine();
                                ...
                                case 18 -> {
                                    if (!dataBase.allLessons.isEmpty()) {
                                        scanner.nextLine();
                                        System.out.println("Все доступные уроки: ");
                                        for (Lesson allLesson : dataBase.allLessons) {
                                        ...
                                        if (foundLesson != null) {
                                            dataBase.deleteLesson(foundLesson);
                                            for (Group group : dataBase.groups) {
                                                for (Lesson lesson : group.lessons) {
                                                    if (lesson.lessonName.equals(lessonName)) {
                                                        group.deleteLesson(lesson);
                                                    }
                                                }
                                            }
                                ...
                                case 19 -> {
                                    if (!dataBase.groups.isEmpty()) {
                                        ...
                                        if (foundGroup != null) {
                                            dataBase.deleteGroup(foundGroup);
                                ...
                                case 21 -> {
                                    if (dataBase.allInstructors.isEmpty()) {
                                        ...
                                        scanner.nextLine();
                                        System.out.println("Все доступные инструкторы:");
                                        for (Instructor instructor : dataBase.allInstructors) {
                                            System.out.println(instructor);
                                        }
                                        System.out.print("Введите email: ");
                                        ...
                                        if (found) {
                                            dataBase.deleteUser(email);
                                            dataBase.deleteInstructor(email);
                                            for (Group group : dataBase.groups) {
                                                for (Instructor instructor : group.instructors) {
                                                    if (instructor.email.equals(email)) {
                                                        group.deleteInstructor(email);
                                                    }
                                                }
                                            }
                                            System.out.println("Инструктор успешно удален!");
                                        } else {
                                            System.out.println("Инструктора с таким email нету!");
                                        }
                                    }
                            ...
                            switch (num) {
                                    ...
                                    if (dataBase.groups.isEmpty()) {
                                        ...
                                        while (true) {
                                            ...
                                            for (int i = 0; i < dataBase.groups.size(); i++) {
                                                System.out.println(i + 1 + ". " + dataBase.groups.get(i));
                                            }
                                            System.out.print("Введите название группы: ");
                                            String groupName = scanner.nextLine();
                                            boolean found = false;
                                ...
                                case 8 -> {
                                    if (dataBase.allLessons.isEmpty()) {
                                        ...
                                        scanner.nextLine();
                                        Group newGroup = getGroup(dataBase, currentUser);
                                        ...
                                        if (foundLesson != null) {
                                            newGroup.deleteLesson(foundLesson);
                                            for (Group group : dataBase.groups) {
                                ...
                                case 9 -> {
                                    if (dataBase.allStudents.isEmpty()) {
                                        ...
                                        scanner.nextLine();
                                        System.out.println("Все студенты:");
                                        for (Student allStudent : dataBase.allStudents) {
    ...
    private static Group getGroup(DataBase dataBase, String email) {
        Group group = null;
        for (Group group1 : dataBase.groups) {
    ...
    private static Group getGroup(DataBase dataBase, User currentUser) {
        Group newGroup = null;
        for (Group group : dataBase.groups) {
            for (Instructor instructor : group.instructors) {
